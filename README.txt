...
Если все тесты завершаются ошибками по используется недействительный ключ API.
В этом случае:
1. Зарегестрироваться на сайте https://coinmarketcap.com/api/ олучить ключ API

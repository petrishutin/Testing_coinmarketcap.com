...
Если все тесты завершаются ошибками Skiped, то сайт https://coinmarketcap.com/ недоступен или  используется
недействительный ключ API .
В этом случае:
1. Проверить соединение
3. Если соединени в порядке. Зарегестрироваться на сайте https://coinmarketcap.com/api/ , получить ключ API
2. Присвоить значение ключа константе API_KEY. (Значение должно быть заключено в кавычки)
...
Все выполнение заняло порядка 16-17 часов:
 ...
 - 8-9 рефакторинг, написание коментариев на английском и русском
